...
loom {
    ...
    launchConfigs {
        "client" {
            ...
            arg("--mixin", "mixins.particlesenhanced.json")
        }
    }
    forge {
        pack200Provider.set(dev.architectury.pack200.java.Pack200Adapter())
        // If you don't want mixins, remove this lines
        mixinConfig("mixins.particlesenhanced.json")
    }
    // If you don't want mixins, remove these lines
    mixin {
        defaultRefmapName.set("mixins.particlesenhanced.refmap.json")
    }
}
...
tasks.shadowJar {
    ...
    fun relocate(name: String) = relocate(name, "dev.isxander.deps.$name")
}
